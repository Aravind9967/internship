...
public class ImageStorageService {
    ...
    public String store(MultipartFile file) {
        ...
        try {
            ...
            log.warn("AUDIT: image stored UNENCRYPTED (dev mode), ref={}", ref);
            return ref;
        } catch (Exception e) {
    ...
    public byte[] retrieve(String imageRef) {
        try {
            ...
            log.warn("AUDIT: image accessed UNENCRYPTED (dev mode), ref={}, by=SYSTEM", imageRef);
            return data;
        } catch (Exception e) {
    ...
    private void validate(MultipartFile file) {
        if (file.isEmpty()) throw new BadRequestException("Image file is empty");
